/**
 * @file frame.h
 * @brief Atom-frame container and distance helper for the OpenMP neighbor-list builder.
 */
...
public:
     ...
     * but the current OpenMP neighbor-list builder inlines the same arithmetic
